...
| [Code Review Quick Wins](v0.0.3/code-review-quick-wins-plan.md) | Low | Planned | July 2026 engine review fixes: Trimesh constructor bug, render-sort GC pressure, `preserveDrawingBuffer`, uniform/bind-group caching, mip allocation, depenetration heights, misc hygiene |
